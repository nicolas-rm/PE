...
system.runInterval( () =>{
  for(let p of world.getPlayers()){
    ...
    let light15 = ["lit_pumpkin", "lava_bucket", "glowstone", "shroomlight", "beacon", "lantern", "sea_lantern", "campfire", "froglight"]
    ...
    let light9 = ["redstone_torch", "redstone_torch_offhand", "ender_chest", "enchanting_table", "catalyst"]
    let light6 = ["magma", "blaze_rod", "blaze_powder", "glow_ink_sac", "glow_berries", "glowstone_dust"]
    let light_offhand = ["new:soul_torch_offhand", "new:redstone_torch_offhand", "new:torch_offhand"]
